...
sendo fornecido o valor de seu raio (R). A fórmula para calcular
 o volume é: (4/3) * pi * R3. Considere (atribua) para pi o 
 valor 3.14159.
...
igualdade. O valor deverá ser apresentado com 3 casas após o 
ponto.
*/
...
public class Problema1011 {
    ...
    double raio, PI, volume, cubico;

    PI = 3.14159;
    raio = entrada.nextDouble();
    cubico = raio * raio * raio;

    volume = (4.0/3) * PI * cubico;
